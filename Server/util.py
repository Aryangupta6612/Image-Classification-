...
def get_cv2_image_from_base64_string(b64str):
    ...
    :return:
    '''
    # Handle cases where the input string does not contain a comma
    if ',' in b64str:
...
def get_b64_test_image_for_virat():
    file_path = r"C:\Users\hp\OneDrive\html by harry\Documents\Desktop\JUPYTER NOTEBOOKS\Image Claasification\Server\base64.txt.txt"
